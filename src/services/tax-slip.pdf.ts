...
export async function buildTaxSlipPdf(data: TaxSlipData): Promise<Buffer> {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (remainingSpace > 50) {
      ...
      if (isPaid) {
        const textWidth = PAGE_WIDTH - 180;
        doc
          .fillColor(COLORS.muted)
          .font(FONT.bold)
          .fontSize(7)
        ...
        doc
          ...
          .font(FONT.regular)
          .fontSize(6)
          .text(`VERIFIED: ${data.slipNumber}`, stampX, stampY + 28, {
            width: stampW,
            align: 'center',
          });
        ...
        doc
          ...
          .text(
            ...
            LEFT,
            y,
            { width: PAGE_WIDTH, align: 'justify', lineGap: 1 }
          );
      }
    }
